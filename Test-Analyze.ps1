...
A ($r9.facts.meta.canonicalVersion -eq 3 -and $r9.facts.meta.factsVersion -eq 3) "e2e14/U9: canonicalVersion=3 (P5 waiver), factsVersion=3 (EXTR-aUniformLattice-1 period strings)"
