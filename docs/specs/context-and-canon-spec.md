...
| U9 | Headline rank precedence (KPI over doc-earlier table total) | [headline-rank-precedence-spec.md](headline-rank-precedence-spec.md) | SPEC (reviewed 2026-07-12, GO-WITH-CHANGES) — build pending; builds 2nd, after U8 (declared order per U9 amendments + cross-cutting critic) |
