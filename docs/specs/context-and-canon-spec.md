...
| U7b | Cross-widget reconciliation #6 (monthly-sum vs period KPI) | [cross-widget-reconciliation-spec.md](cross-widget-reconciliation-spec.md) | shipped (built 2026-07-14 with MF-1..MF-9 folded; `Analyze-SwydoTrend.ps1` new `-PeriodKpiFacts`, `Get-MonthSpan`/`Get-MonthRangeSum`, all findings INFO in v1; additive on TrendAnalyze 24 -> 64) |
