...
- EXTR-aUniformLattice-1 - the previous-period column came from the dashboard's saved compare selector, unrecorded and volatile; the extractor now computes, passes and records the window -> [proven periods](builds/2026-08-05-EXTR-aUniformLattice/spec/2026-08-05-spec-aUniformLattice-1.md)
