...
- INPROGRESS - EXTR-aPatientHarvest-1 - extractor completeness under a slow Swydo backend: consume the discarded kind:3 RESOLVED signal, budget the fetch by wall clock, fail closed on an incomplete pull -> [spec](builds/2026-08-04-EXTR-aPatientHarvest/spec/2026-08-04-spec-aPatientHarvest-1.md)
